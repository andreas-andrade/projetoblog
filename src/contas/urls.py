...
urlpatterns = patterns('contas.views',
    ...
    url('^pagar/(?P<conta_id>\d+)/$', 'conta', {'classe': ContaPagar}, 
        name='conta_a_pagar'), #a variavel classe sera passada por paramatro para a view "conta"
                               #a string 'conta' é o nome da view a ser chamada
    url('^receber/(?P<conta_id>\d+)/$', 'conta', {'classe': ContaReceber}, 
        name='conta_a_receber'),#a variavel classe sera passada por paramatro para a view "conta"
                                #a string 'conta' é o nome da view a ser chamada
