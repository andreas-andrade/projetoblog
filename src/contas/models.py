...
class Conta(models.Model):
    class Meta:
        ...
        permissions = (('ver_todos_os_usuarios', 'Ver todos os usuarios'),) #nome da permissao e apelido
    ...
    def __unicode__(self):
        ...
        return '%s - %s. Vencimento:(%s)'%(valor, self.pessoa.nome, data_vencto)
...
class ContaPagar(Conta):
    ...
    def lancar_pagamento(self, data_pagamento, valor):
        return PagamentoPago.objects.create(conta=self, data_pagamento=data_pagamento, valor=valor, )
    class Meta:
        verbose_name_plural = u'Contas a Pagar'
        verbose_name = u'Contas a Pagar'
...
class ContaReceber(Conta):
    ...
    def lancar_pagamento(self, data_pagamento, valor):
        return PagamentoRecebido.objects.create(conta=self, data_pagamento=data_pagamento, valor=valor, )

    class Meta:
        verbose_name_plural = u'Contas a Receber'
        verbose_name = u'Contas a Receber'
